...
import com.news.lz.utils.AnimationUtils;
import com.news.lz.utils.ThemeUtils;
 ...
 * with this layout, you can call {@link #setupWithViewPager(CustomViewPager)} to link the two together.
...
public class TabLayout extends HorizontalScrollView {
     ...
     *
     * <p>This is the same as calling {@link #setupWithViewPager(CustomViewPager, boolean)} with
     * auto-refresh enabled.</p>
     *
     * @param viewPager the ViewPager to link to, or {@code null} to clear any previous link
     */
    public void setupWithViewPager(@Nullable CustomViewPager viewPager) {
     ...
     *
     * @param viewPager   the CustomViewPager to link to, or {@code null} to clear any previous link
     * @param autoRefresh whether this layout should refresh its contents if the given ViewPager's
     *                    content changes
     */
    public void setupWithViewPager(@Nullable final CustomViewPager viewPager, boolean autoRefresh) {
        setupWithViewPager(viewPager, autoRefresh, false);
    }

    private void setupWithViewPager(@Nullable final CustomViewPager viewPager, boolean autoRefresh,
    ...
    /**
     * @deprecated Use {@link #setupWithViewPager(CustomViewPager)} to link a TabLayout with a ViewPager
    ...
    protected void onAttachedToWindow() {
        ...
        if (mViewPager == null) {
            ...
            if (vp instanceof ViewPager) {
                ...
                setupWithViewPager((CustomViewPager) vp, true, true);
            }
        }
    }
     ...
     * not cause a leak.
     */
    public static class TabLayoutOnPageChangeListener implements CustomViewPager.OnPageChangeListener {
    ...
    public static class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        ...
        public ViewPagerOnTabSelectedListener(CustomViewPager viewPager) {
            mViewPager = viewPager;
        }
    ...
    private class AdapterChangeListener implements CustomViewPager.OnAdapterChangeListener {
        ...
        @Override
        public void onAdapterChanged(@NonNull CustomViewPager viewPager,
